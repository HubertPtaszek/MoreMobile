<template>
    <ion-page>
        <ion-content class="flow-root">
            <ion-progress-bar type="indeterminate" v-if="showSignUpProgress"></ion-progress-bar>
                ...
                <ion-grid class="ion-no-padding">
                    <ion-row class="ion-justify-content-center ion-padding-top">
                        <ion-col size="9">
                            ...
                            <ion-toast :is-open="signupError.isVisible" @didDismiss="closeToast()" class="error-toast" :message="signupError.message" :duration="3000"></ion-toast>
        ...
        async onLoginBtnClick() {
            if (!this.validateFormInputs()) return;
                ...
                signupResult ? 
                    ...
                    this.signInError = { message: "Błąd rejestracji", isVisible: true };
            }
        },
