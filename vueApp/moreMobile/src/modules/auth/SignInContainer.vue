        ...
        <ion-grid class="ion-no-padding">
          <ion-row class="ion-justify-content-center ion-padding-top">
            <ion-col size="9">
              ...
              <div class="registration-link mt-6">
                <RouterLink to="/register"><ion-icon
                    :icon="icons.personAdd"
                  ></ion-icon><span> Rejestracja</span></RouterLink>
              </div>
              <div class="forgot-password mt-3">
                <RouterLink to="/forgot-password"><ion-icon
                    :icon="icons.refreshIcon"
                  ></ion-icon> <span> Odświeżanie hasła</span></RouterLink>
              </div>
            </ion-col>
          </ion-row>
        </ion-grid>
...
export default {
  ...
  methods: {
    ...
    async resendConfirmationEmail() {
      const resendConfirmationEmailResult = await this.resendConfirmEmail.login(
        this.authFormFields
      );
